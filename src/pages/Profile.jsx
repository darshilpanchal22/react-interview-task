            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2 bg-[#1e293b] border border-slate-800 rounded-3xl p-8">
                    ...
                    <form onSubmit={handleUpdate} className="space-y-6">
                        ...
                        <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-3 rounded-xl transition-all">
                            Save Changes
                        </button>
                    </form>
                </div>
                ...
                <div className="bg-[#1e293b] border border-slate-800 rounded-3xl p-8 flex flex-col items-center text-center">
                    <img src={`https://api.dicebear.com/7.x/initials/svg?seed=${name}`} className="w-24 h-24 rounded-full border-4 border-slate-800 mb-4" alt="" />
                    <h3 className="text-white font-bold">{name}</h3>
                    <p className="text-slate-500 text-xs mb-6 uppercase tracking-widest">Pro Member</p>
